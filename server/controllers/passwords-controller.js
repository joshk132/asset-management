  ...
  async.waterfall([
    ...
    function(token, user, done) {
     let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: secrets.mailgun.domain, // generated ethereal user
            pass: secrets.mailgun.password  // generated ethereal password
        },
        tls:{
      ...
      var mailOptions = {
        to: newUserEmail,
        from: '"Phantom Asset Management" noreply@example.com',
        subject: 'Reset your password on phantomam.com',
      ...
      transporter.sendMail(mailOptions, (err, info) => {
          ...
          req.flash('info', { msg: 'An e-mail has been sent to ' + newUserEmail + ' with further instructions.' });
        done(err, 'done');
      });
    }
  ], function(err) {
